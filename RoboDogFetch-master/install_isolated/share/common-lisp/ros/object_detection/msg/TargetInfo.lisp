...
(cl:defmethod cl:initialize-instance :after ((m <TargetInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TargetInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_detection-msg:<TargetInfo> is deprecated: use object_detection-msg:TargetInfo instead.")))

(cl:ensure-generic-function 'target_type-val :lambda-list '(m))
(cl:defmethod target_type-val ((m <TargetInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_detection-msg:target_type-val is deprecated.  Use object_detection-msg:target_type instead.")
  (target_type m))
